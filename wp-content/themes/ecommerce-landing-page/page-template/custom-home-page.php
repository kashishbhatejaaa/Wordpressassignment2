        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-12 banner-main-text align-self-center">
            <div class="inner_carousel">
              ...
              <?php }?>
              <?php if(get_theme_mod('ecommerce_landing_page_tagline_title1') != '') {?>
               <h1 class="small-headphone"><?php echo esc_html(get_theme_mod('ecommerce_landing_page_tagline_title1')) ?></h1>
              <?php }?>
