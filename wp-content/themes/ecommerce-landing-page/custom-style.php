<?php
	...
	$ecommerce_landing_page_footer_icon = get_theme_mod('ecommerce_landing_page_footer_icon');
	if($ecommerce_landing_page_footer_icon == false){
		$ecommerce_landing_page_custom_css .='#footer-2 p{';
			$ecommerce_landing_page_custom_css .='width:100%; text-align:center; float:none;';
		$ecommerce_landing_page_custom_css .='}';
	}
